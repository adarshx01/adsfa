  ...
  return (
    <div className='containered h-[100%] h-screen'>
            <div className="h-[100vh] pt-20" >
              ...
              <button className="button"><Link href='chemistry/buffer'>Buffer Solution</Link></button>
              <button className="button"><Link href='chemistry/balancer'>Equation Balancing</Link></button>
              <button className="button"><Link href='chemistry/equillibrium'>Equillibrium</Link></button>
